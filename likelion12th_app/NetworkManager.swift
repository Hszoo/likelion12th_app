...
class NetworkManager {
    ...
    func postMemberData<T: Codable>(to endpoint: String, body: T, completion: @escaping (Result<Data, Error>) -> Void) {
            postRequest(to: endpoint, body: body, completion: completion)
    }

    func postMessageData<T: Codable>(to endpoint: String, body: T, completion: @escaping (Result<Data, Error>) -> Void) {
            postRequest(to: endpoint, body: body, completion: completion)
    }
